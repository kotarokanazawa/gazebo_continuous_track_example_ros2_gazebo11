        ...
        [
            {
                ...
                "pose": (0.0, -0.7, 0.3, 0.0, 0.0, 0.0),
            },
            {
                "entity": "example_track_simple",
                "xacro": "example_track_simple_gazebo.urdf.xacro",
                "pose": (0.0, 0.0, 0.3, 0.0, 0.0, 0.0),
            },
            {
                "entity": "example_track_simple_wheels",
                "xacro": "example_track_simple_wheels_gazebo.urdf.xacro",
                "pose": (0.0, 0.7, 0.3, 0.0, 0.0, 0.0),
            },
        ],
